...
\title{Lösung 9.4}
\author{Zehra Ciftci, Sude Cinar, Saveen Kassem}
\date{January 2022}
...
mit natürlichem m $>$ 2. Außerdem gilt: $k^m > k^2$   \iff  $$\frac{1}{k^2} < \frac{1}{k^m}$$.
...
$\[ \displaystyle\sum_{k=1}^{\infty}\frac{1}{k^{2}}\] < \[ \displaystyle\sum_{k=1}^{\infty}\frac{2}{(k+1)}=2}\] $. 
  
 \vspace{0.5 cm}
Nach dem Axiom der Transitivität der Anorndnung gilt: 

$\[ \displaystyle\sum_{k=1}^{\infty}\frac{1}{k^{m}}\] < \[ \displaystyle\sum_{k=1}^{\infty}\frac{1}{k^{2}}\] < \[ \displaystyle\sum_{k=1}^{\infty}\frac{2}{(k+1)}=2}\] $

\vspace{0.5 cm}
Nun kann man mit der Definition der Riemannschen-Zeta-Funktion ausdrücken, dass mit einer weiterhin natürlichen Zahl größer 2 folgendes gilt:
\vspace{0.5 cm}

$\[\zeta(m) = \displaystyle\sum_{k=1}^{\infty}\frac{1}{k^{m}}\] < \[\zeta(2) = \displaystyle\sum_{k=1}^{\infty}\frac{1}{k^{2}}\] < \[ \displaystyle\sum_{k=1}^{\infty}\frac{2}{(k+1)}=2}\]$
